 ...
 * generated in the com.oracle.csm.soapwsexample.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldResponse_QNAME = new QName("http://soapwstemplate.csm.oracle.com/", "sayHelloWorldResponse");
    private final static QName _SayHelloWorld_QNAME = new QName("http://soapwstemplate.csm.oracle.com/", "sayHelloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oracle.csm.soapwsexample.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapwstemplate.csm.oracle.com/", name = "sayHelloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapwstemplate.csm.oracle.com/", name = "sayHelloWorld")
